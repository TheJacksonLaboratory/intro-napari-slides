...
- since then, the project has grown considerably, with >150 contributors and >500 plugins
...
:::{.callout-tip}
The [napari bundled application](https://napari.org/stable/tutorials/fundamentals/installation.html#install-as-a-bundled-app) is stand alone and can be launched from your OS GUI
:::
...
viewer.dims.ndisplay = 3
viewer.camera.angles = (-40, 40, 140)
